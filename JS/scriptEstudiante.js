document.addEventListener('DOMContentLoaded', function () {
    ...
    function obtenerRespuesta(valorBuscado) {
        fetch('./JSON/estudiantes/respuestas_estudiantes_plataforma.json')
    ...
    fetch('./JSON/estudiantes/categorias_estudiantes.json')
        .then(response => response.json())
        .then(categorias => {
            // Fetch para obtener las preguntas
            fetch('./JSON/estudiantes/preguntas_estudiantes_plataforma.json')
                .then(response => response.json())
                .then(preguntas => {
